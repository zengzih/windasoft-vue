                ...
                <section :class="[ signIn ? 'section-sign-in' : 'section-sign-up']">
                    ...
                    <transition>
                        <div v-show="!signIn" class="section-group">
                            ...
                            <!--<div>
                                <input type="text" v-model="signUpFormData.phone" placeholder="输入手机号">
                            </div>
                            <div>
                                <input :type="passType" placeholder="输入图片验证码">
                                <img @click="getImgVerifyCode" :src="imgVerifyCodeSrc" class="verify-code" alt="">
                            </div>
                            <div>
                                <input :type="passType" placeholder="输入短信验证码">
                                <el-button @click="getMessageVerifyCode" class="verify-code btn" type="primary" size="mini">获取验证码</el-button>
                            </div>
                            <div>
                                <input :type="passType" placeholder="设置6-16位密码">
                                <i :class="['seltarr', passType == 'password' ? 'password_icon_off' : 'password_icon_on' ]" @click="handleShowPassword()"></i>
                            </div>-->
                        </div>
                    </transition>
